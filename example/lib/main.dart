...
import 'package:flutter_bloc_manager_example/state_emitters/main_cubit_state_emitter.dart';
import 'package:flutter_bloc_manager_example/states/dependent_cubit/dependent_cubit.dart';
...
class _AppState extends State<App> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Bloc manager example app'),
        ),
        body: Center(
          child: Column(
